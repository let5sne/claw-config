...
[![i18n](https://img.shields.io/badge/i18n-4%20languages-blue)](#国际化)
...
### Agents 配置
- 配置 OpenClaw Agents 默认行为
- 模型分层配置（primary、fast、balanced、powerful）
- 并发数调优
- 性能参数设置
...
1. 在 `src/i18n/locales/[code].json` 创建新的翻译文件
2. 更新 `src/i18n/config.ts` 导入并注册新语言
3. 在 `src/components/LanguageSelector.tsx` 添加语言选项
